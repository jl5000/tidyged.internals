...
test_that("Function FAMILY_EVENT_STRUCTURE() @ L401", {
...
test_that("Function INDIVIDUAL_ATTRIBUTE_STRUCTURE() @ L453", {
...
test_that("Function INDIVIDUAL_EVENT_DETAIL() @ L503", {
...
test_that("Function INDIVIDUAL_EVENT_STRUCTURE() @ L539", {
...
test_that("Function SOURCE_CITATION() @ L932", {
...
test_that("Function SOURCE_REPOSITORY_CITATION() @ L990", {
...
test_that("Function SPOUSE_TO_FAMILY_LINK() @ L1021", {
