...
test_that("Function date_exact_pattern() @ L74", {
...
test_that("Function date_pattern() @ L97", {
...
test_that("Function date_period_pattern() @ L127", {
...
test_that("Function date_range_pattern() @ L158", {
...
test_that("Function date_approximated_pattern() @ L189", {
...
test_that("Function date_value_pattern() @ L228", {
