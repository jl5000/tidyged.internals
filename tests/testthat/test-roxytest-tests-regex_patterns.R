...
context("File R/regex_patterns.R: @tests")

test_that("Function reg_date_exact() @ L113", {
...
test_that("Function reg_date() @ L144", {
...
test_that("Function reg_date_period() @ L186", {
...
test_that("Function reg_date_range() @ L217", {
...
test_that("Function reg_date_approximated() @ L248", {
...
test_that("Function reg_date_value() @ L287", {
