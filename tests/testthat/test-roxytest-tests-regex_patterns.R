...
test_that("Function date_exact_pattern() @ L91", {
...
test_that("Function date_pattern() @ L117", {
...
test_that("Function date_period_pattern() @ L161", {
...
test_that("Function date_range_pattern() @ L192", {
...
test_that("Function date_approximated_pattern() @ L223", {
...
test_that("Function date_value_pattern() @ L262", {
