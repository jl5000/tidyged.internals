...
test_that("Function reg_date_period() @ L180", {
...
test_that("Function reg_date_range() @ L211", {
...
test_that("Function reg_date_approximated() @ L242", {
...
test_that("Function reg_date_value() @ L281", {
