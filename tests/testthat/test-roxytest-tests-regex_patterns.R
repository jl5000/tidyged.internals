...
test_that("Function date_exact_pattern() @ L82", {
...
test_that("Function date_pattern() @ L108", {
...
test_that("Function date_period_pattern() @ L152", {
...
test_that("Function date_range_pattern() @ L183", {
...
test_that("Function date_approximated_pattern() @ L214", {
...
test_that("Function date_value_pattern() @ L253", {
