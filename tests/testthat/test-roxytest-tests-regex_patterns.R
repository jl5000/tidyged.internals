...
test_that("Function date_exact_pattern() @ L88", {
...
test_that("Function date_pattern() @ L114", {
...
test_that("Function date_period_pattern() @ L158", {
...
test_that("Function date_range_pattern() @ L189", {
...
test_that("Function date_approximated_pattern() @ L220", {
...
test_that("Function date_value_pattern() @ L259", {
