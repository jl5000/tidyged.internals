...
test_that("Function reg_date_exact() @ L88", {
...
test_that("Function reg_date() @ L114", {
...
test_that("Function reg_date_period() @ L158", {
...
test_that("Function reg_date_range() @ L189", {
...
test_that("Function reg_date_approximated() @ L220", {
...
test_that("Function reg_date_value() @ L259", {
