...
test_that("Function GEDCOM_HEADER() @ L29", {
...
test_that("Function FAMILY_GROUP_RECORD() @ L87", {
...
test_that("Function INDIVIDUAL_RECORD() @ L174", {
...
test_that("Function MULTIMEDIA_RECORD() @ L264", {
...
test_that("Function NOTE_RECORD() @ L339", {
...
test_that("Function REPOSITORY_RECORD() @ L402", {
...
test_that("Function SOURCE_RECORD() @ L467", {
...
test_that("Function SUBMITTER_RECORD() @ L568", {
...
test_that("Function FOOTER_SECTION() @ L606", {
