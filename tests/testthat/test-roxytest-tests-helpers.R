...
test_that("Function remove_section() @ L54", {
...
test_that("Function gedcom_value_update() @ L191", {
  expect_identical(gedcom_value_update(tibble::tibble(), "@1@", "TAG", 4, 5, 6), tibble::tibble())
})


test_that("Function construct_full_name() @ L245", {
